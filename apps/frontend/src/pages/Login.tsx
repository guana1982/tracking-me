...
export function Login() {
  ...
  const handleGoogleLogin = () => {
    // Redirect to backend OAuth endpoint (full URL, not relative)
    ...
    <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-4">
      <div className="max-w-sm w-full">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500 mt-2">Gestisci le tue finanze con la regola 65/25/10</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 bg-white border border-slate-200 rounded-xl px-4 py-3 text-slate-700 font-medium hover:bg-slate-50 hover:border-slate-300 transition-colors"
          >
